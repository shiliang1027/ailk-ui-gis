package com.ailk.common.ui.gis.tools
{
	 ...
	 *
	 */
	public class OverViewTool extends UIComponent
	{
		private static var log:ILogger=Log.getLoggerByClass(OverViewTool);
		private var _mapWork:MapWork;
		
		public function OverViewTool()
		{
			super();
		}
		override protected function createChildren():void
		{
			...
			if(_mapWork.map){
				_mapWork.map.updateOverViewToolDisplay(this);
			}
